...
class Lexer:
	...
	def make_tokens(self):
		...
		while self.current_char != None:
			if self.current_char in " \t":
				...
				self.advance()
				return [], IllegalCharError(self.pos.copy(), self.pos, "'"+char+"'")
	...
	def make_number(self):
		...
		while self.current_char != None and self.current_char in DIGITS + ".":
			...
			self.advance()
		if dot_count == 0:return Token(TT_INT, int(num_str), self.pos.copy(), self.pos)
		if dot_count == 1:return Token(TT_FLOAT, float(num_str), self.pos.copy(), self.pos)
